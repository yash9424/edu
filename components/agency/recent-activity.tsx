  ...
  useRealTimeUpdates({
    ...
    onUpdate: (event) => {
      ...
      const newActivity: Activity = {
        ...
        user: event.data.studentName || event.data.name || 'System',
        timestamp: new Date(),
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Latest updates and actions for your agency</CardDescription>
      </CardHeader>
      <CardContent>
